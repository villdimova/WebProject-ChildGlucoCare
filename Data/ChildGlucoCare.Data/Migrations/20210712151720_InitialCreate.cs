        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsulinSensitivity = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Peak = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentGlucoseLevel = table.Column<double>(type: "float", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BloodGlocoseStatus = table.Column<int>(type: "int", nullable: false),
                    SuggestedCorrectionDoseInsulin = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BloodGlucoses_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarbohydrateIntakes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TotalMealBeu = table.Column<double>(type: "float", nullable: false),
                    CurrentGlucoselevel = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsulinInjections_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SportActivities_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SportActivities_Sports_SportId",
                        column: x => x.SportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodIntakes_CarbohydrateIntakes_CarbohydrateIntakeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BloodGlucoses_ApplicationUserId",
                table: "BloodGlucoses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarbohydrateIntakes_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodIntakes_CarbohydrateIntakeId",
                table: "FoodIntakes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsulinInjections_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SportActivities_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SportActivities_SportId",
                table: "SportActivities",
                column: "SportId");
