namespace ChildGlucoCare.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<DiabeticDiary> DiabeticDiaries { get; set; }

        public DbSet<BloodGlucose> BloodGlucoses { get; set; }

        public DbSet<CarbohydrateIntake> CarbohidrateIntakes { get; set; }

        public DbSet<FoodCarbohydrateIntake> FoodCarbohydrateIntakes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<FoodCarbohydrateIntake>()
                .HasKey(k => new { k.CarbohydrateIntakeId, k.FoodId });
